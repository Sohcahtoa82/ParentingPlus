...
- (void)getBehaviorDataFromDB
{
    ...
    for(id btk in behaviorToKeepStatsFromDB){
        [cellStructure addObject: @{@"cell_type": @"H2Cell", @"data_type": @"Label", @"data": [((NSString *)btk[@"bhname"]) capitalizedString] }];
    ...
    for(id btk in behaviorToChangeStatsFromDB){
        if(![lastBTC isEqual: btk[@"badBehavior_name"]]){
            ...
            [cellStructure addObject: @{@"cell_type": @"H2Cell", @"data_type": @"Label", @"data": [lastBTC capitalizedString]}];
        }
        [cellStructure addObject: @{@"cell_type": @"H3Cell", @"data_type": @"Label", @"data": [((NSString *)btk[@"bhname"]) capitalizedString]}];

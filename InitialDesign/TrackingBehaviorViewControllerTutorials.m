...
- (void)viewDidLoad
{
    ...
    [tutorials showTutorialAtX:100 atY:100 withID:TUT_BEHAVIORS_1 inView:self.tableView withOrientation:POINTING_UP withCallback:@selector(showNextTutorial) fromSender:self];
    currentTutorial = 1;
}
